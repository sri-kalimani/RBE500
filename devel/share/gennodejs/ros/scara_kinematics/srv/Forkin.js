...
class ForkinRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ForkinRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ForkinRequest
    let len;
    let data = new ForkinRequest(null);
  ...
  static datatype() {
    ...
    return 'scara_kinematics/ForkinRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ForkinRequest(null);
...
class ForkinResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ForkinResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ForkinResponse
    let len;
    let data = new ForkinResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'scara_kinematics/ForkinResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ForkinResponse(null);
...
module.exports = {
  Request: ForkinRequest,
  Response: ForkinResponse,
  md5sum() { return '4938f680caba403e8ef27465568d7ea8'; },
  datatype() { return 'scara_kinematics/Forkin'; }
};
