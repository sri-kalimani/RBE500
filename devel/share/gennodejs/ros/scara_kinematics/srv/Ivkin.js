...
class IvkinRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IvkinRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IvkinRequest
    let len;
    let data = new IvkinRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new IvkinRequest(null);
...
class IvkinResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IvkinResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IvkinResponse
    let len;
    let data = new IvkinResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new IvkinResponse(null);
...
module.exports = {
  Request: IvkinRequest,
  Response: IvkinResponse,
  md5sum() { return 'def04ee6e0781ddbf5524d947db623d7'; },
  datatype() { return 'scara_kinematics/Ivkin'; }
};
