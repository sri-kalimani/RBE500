...
message(STATUS "scara_kinematics: 0 messages, 6 services")
...
get_filename_component(_filename "/home/ben/RBE500/src/scara_kinematics/srv/Ivkin.srv" NAME_WE)
add_custom_target(_scara_kinematics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "scara_kinematics" "/home/ben/RBE500/src/scara_kinematics/srv/Ivkin.srv" "geometry_msgs/Vector3:geometry_msgs/Pose:geometry_msgs/Quaternion:geometry_msgs/Point"
)

get_filename_component(_filename "/home/ben/RBE500/src/scara_kinematics/srv/Forkin.srv" NAME_WE)
add_custom_target(_scara_kinematics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "scara_kinematics" "/home/ben/RBE500/src/scara_kinematics/srv/Forkin.srv" "geometry_msgs/Pose:geometry_msgs/Point:geometry_msgs/Quaternion:geometry_msgs/Vector3"
)

get_filename_component(_filename "/home/ben/RBE500/src/scara_kinematics/srv/MoveToJoints.srv" NAME_WE)
add_custom_target(_scara_kinematics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "scara_kinematics" "/home/ben/RBE500/src/scara_kinematics/srv/MoveToJoints.srv" "geometry_msgs/Pose:geometry_msgs/Point:geometry_msgs/Quaternion:geometry_msgs/Vector3"
)

get_filename_component(_filename "/home/ben/RBE500/src/scara_kinematics/srv/MoveRobot.srv" NAME_WE)
add_custom_target(_scara_kinematics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "scara_kinematics" "/home/ben/RBE500/src/scara_kinematics/srv/MoveRobot.srv" ""
)

get_filename_component(_filename "/home/ben/RBE500/src/scara_kinematics/srv/MoveToPoint.srv" NAME_WE)
add_custom_target(_scara_kinematics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "scara_kinematics" "/home/ben/RBE500/src/scara_kinematics/srv/MoveToPoint.srv" "geometry_msgs/Vector3:geometry_msgs/Pose:geometry_msgs/Quaternion:geometry_msgs/Point"
)

get_filename_component(_filename "/home/ben/RBE500/src/scara_kinematics/srv/MoveRobot_3.srv" NAME_WE)
add_custom_target(_scara_kinematics_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "scara_kinematics" "/home/ben/RBE500/src/scara_kinematics/srv/MoveRobot_3.srv" ""
)
