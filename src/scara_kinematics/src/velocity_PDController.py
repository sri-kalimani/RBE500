...
class PDController_3:
    ...
    def __init__(self, P1=.1, D1=.05,P2=.1,D2=.05,P3=.1,D3=.05):
        rospy.init_node('velocity_PDController')
        ...
        self.control_service = rospy.Service('velocity_control_3', MoveRobot_3, self.performControl)
